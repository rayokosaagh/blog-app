...
export default function LoginClient({ animatedBackground }: { animatedBackground: boolean }) {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-background px-4 overflow-hidden">
      {/* Shared neo-brutalist animated backdrop (grid + flying shapes), behind
          the same dashboard toggle as the homepage's. */}
      {animatedBackground && <AnimatedBackground className="absolute inset-0 z-0" />}
