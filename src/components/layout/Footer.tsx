...
// don't exist yet — point them at real routes once those pages are built.
const USEFUL_LINKS = [
  { label: "News", href: "/blog" },
  { label: "Compare Gadgets", href: "/compare" },
...
// Single-path brand glyphs (24×24, currentColor). Replace `href` with your
// real profile URLs.
const SOCIALS = [
  {
    label: "YouTube",
              ...
              <div className="mt-5 flex flex-wrap gap-2.5">
                {SOCIALS.map((social) => (
                  <Link
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-none border-2 border-border-heavy bg-card text-foreground shadow-brutal-sm brutal-press transition-colors duration-100 hover:bg-accent hover:text-on-accent"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      className="h-5 w-5"
