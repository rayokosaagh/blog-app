...
export const laptops: GadgetCategoryDef = {
  ...
  groups:  [
  {
    ...
    fields: [
      ...
      { key: "announcedDate", label: "Announcement Date", type: "text", important: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "processorModel", label: "Processor Model", type: "text", important: true },
      { key: "coresThreads", label: "Cores / Threads", type: "text", important: true },
  ...
  },
  {
    ...
    fields: [
      { key: "gpuModel", label: "GPU Model Name", type: "text", important: true },
      { key: "graphicsType", label: "Graphics Setup", type: "select", options: ["Dedicated", "Integrated", "Switchable (MUX/Optimus)"] },
      { key: "vram", label: "Video Memory (VRAM)", type: "text", important: true },
  ...
  },
  {
    ...
    fields: [
      { key: "installedRam", label: "Installed RAM Capacity", type: "text", important: true },
      ...
      { key: "primarySsd", label: "Default SSD Configuration", type: "text", important: true },
  ...
  },
  {
    ...
    fields: [
      { key: "screenSize", label: "Screen Diagonal Size", type: "text", important: true },
      { key: "panelType", label: "Display Panel Type", type: "select", options: ["Mini LED", "OLED", "IPS / LCD", "TN", "VA"], important: true },
      ...
      { key: "resolution", label: "Native Resolution / Aspect Ratio", type: "text", important: true },
      { key: "refreshRate", label: "Panel Refresh Rate", type: "text", important: true },
  ...
  },
  {
    ...
    fields: [
      { key: "batteryCapacity", label: "Internal Battery Capacity", type: "text", important: true },
      { key: "powerAdapter", label: "AC Charger Brick Wattage", type: "text" },
      { key: "operatingSystem", label: "Primary Operating System", type: "select", options: ["Windows 11 Home", "Windows 11 Pro", "macOS", "Linux / Ubuntu", "No OS"], important: true },
